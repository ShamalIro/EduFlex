...
export default function AddLesson() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('lessonTitle', form.lessonTitle);
      formData.append('lessonDescription', form.lessonDescription);
  ...
  return (
    <div style={s.content}>
          <div style={s.pageHeader}>
            <h1 style={s.pageTitle}>Add New Lesson</h1>
            <p style={s.pageSubtitle}>Introduction to React — fill in the lesson details below</p>
          </div>
          ...
          <div style={s.card}>
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ marginBottom: 16 }}>
                <div style={s.tabRow}>
                  <button type="button" style={s.tab(videoMode === "url")} onClick={() => { setVideoMode("url"); setErrors(p => ({ ...p, videoFile: undefined })); }}>
                    🔗 Video URL
                  </button>
                  <button type="button" style={s.tab(videoMode === "file")} onClick={() => { setVideoMode("file"); setErrors(p => ({ ...p, videoUrl: undefined })); }}>
                    ⬆ Upload Video
                  </button>
                </div>
                ...
                {videoMode === "url" ? (
                  ...
                  <div style={s.fieldFull}>
                    <label style={s.label}>
                      Upload Video File <span style={s.required}>*</span>
                    </label>
                    <div
                    ...
                    >
                      ...
                      <div style={s.dropText}>Drag & drop your video here, or <span style={{ color: "#4f46e5", fontWeight: 600 }}>browse</span></div>
                      <div style={s.dropHint}>MP4, WebM, MOV — max 500MB</div>
                    </div>
                    <input
                    ...
                    {videoFileName && (
                      <div style={s.fileChip}>
                        🎞 {videoFileName}
                        <span
                          style={{ cursor: "pointer", color: "#6b7280", marginLeft: 4 }}
                          onClick={(e) => { e.stopPropagation(); setVideoFileName(""); setForm(p => ({ ...p, videoFile: null })); }}
                        >✕</span>
                      </div>
                    )}
              ...
              {/* ── Section 3: PDF ── */}
              <div style={s.sectionTitle}>📄 Lesson PDF / Notes</div>

              <div style={s.fieldFull}>
                <label style={s.label}>
                  Upload PDF <span style={s.required}>*</span>
                </label>
                <div
                ...
                >
                  <div style={s.dropIcon}>📎</div>
                  <div style={s.dropText}>Drag & drop your PDF here, or <span style={{ color: "#4f46e5", fontWeight: 600 }}>browse</span></div>
                  <div style={s.dropHint}>PDF only — max 20MB</div>
                </div>
                <input
                  ref={pdfInputRef}
                  type="file"
                ...
                {pdfName && (
                  <div style={s.fileChip}>
                    ...
                    <span
                      style={{ cursor: "pointer", color: "#6b7280", marginLeft: 4 }}
                      onClick={(e) => { e.stopPropagation(); setPdfName(""); setForm(p => ({ ...p, pdfFile: null })); }}
                    >✕</span>
                  </div>
                )}
              ...
              <div style={s.btnRow}>
                ...
                <button type="button" style={{ ...s.btnSecondary }} onClick={() => navigate('/tutor/courses')}>
                  ← Back to Course
                </button>
